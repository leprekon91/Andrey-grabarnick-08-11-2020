/**
 * This is the default avatar that is shown if the user did not upload an image for his own avatar.
 * It will assign a "google"-like color to the first letter of the username and display it
 */
...
const DefaultAvatar = ({ name, size, fontFamily, ...props }) => {
  ...
  <text text-anchor="middle" font-family="${fontFamily}" x="50%" y="50%" dy="0.35em" fill="white" font-size="${textSize}">${char}</text>
</svg>`;
